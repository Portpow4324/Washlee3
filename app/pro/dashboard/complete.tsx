...
import { 
  Briefcase, DollarSign, Star, TrendingUp, MapPin, Clock, CheckCircle, AlertCircle, Settings, Calendar, Eye
} from 'lucide-react'
...
export default function ProDashboard() {
  ...
  useEffect(() => {
    ...
    // Check if user is pro/employee
    if (userData?.user_type !== 'pro') {
      console.log('[ProDashboard] User is not a pro, redirecting')
    ...
    const loadJobs = async () => {
      try {
        ...
        // Fetch all active/pending jobs for this pro
        ...
        if (jobsError) {
          console.error('[ProDashboard] Error fetching jobs:', jobsError)
        ...
        console.log('[ProDashboard] Loaded jobs:', transformedJobs)
    ...
    const subscription = supabase
      ...
      .on(
        ...
        () => {
          console.log('[ProDashboard] Real-time update received')
          loadJobs()
        }
      )
      .subscribe()
              ...
              <div className="space-y-3">
                {jobsLoading ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-sm text-gray">Check back soon for new job assignments</p>
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg border border-gray/10 p-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p><span className="text-gray">Member Since:</span> <span className="text-dark font-semibold">{new Date(user.created_at || '').toLocaleDateString('en-AU')}</span></p>
              </div>
            </div>
