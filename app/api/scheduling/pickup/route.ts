...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('[Pickup Slots API] Received request:', { date, address, duration_minutes })

    // Validate input
    if (!date || !address) {
      console.error('[Pickup Slots API] Missing required fields:', { date, address })
    ...
    console.log('[Pickup Slots API] Request valid, generating slots')
