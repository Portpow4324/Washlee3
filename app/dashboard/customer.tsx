...
import { 
  Package, TrendingUp, DollarSign, Zap, Settings, Calendar, MapPin, Eye, ChevronRight
} from 'lucide-react'
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-primary/10 to-accent/10 rounded-lg border border-primary/20 p-6">
              ...
              <div className="space-y-2 text-sm">
                <p><span className="text-gray">Email:</span> <span className="text-dark font-semibold">{user.email}</span></p>
