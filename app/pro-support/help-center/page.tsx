  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        {/* Bottom CTA */}
        <section className="bg-gradient-to-br from-primary to-accent py-16 sm:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Can't find what you're looking for?
            </h2>
            <p className="text-white/90 text-lg mb-8">
              Submit a request and our support team will get back to you within 24 hours.
            </p>
            <Link
              href="/pro-support/help-center"
              className="inline-block bg-white text-primary px-8 py-4 rounded-lg font-semibold hover:shadow-lg transition"
            >
              Submit a Request
            </Link>
          </div>
