...
export default function Booking() {
  ...
  // Select address and validate it
  const selectAddress = async (prediction: any) => {
    try {
      ...
      if (data.addressParts?.country?.toLowerCase() !== 'australia') {
        setAddressError('❌ Address must be in Australia')
      ...
      setBookingData({
        ...bookingData,
        deliveryAddress: data.addressParts.formattedAddress,
        deliveryAddressDetails: data.addressParts,
      })
            ...
            <Card className="p-8 mb-8">
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <input
                    type="text"
                    value={addressInput || bookingData.deliveryAddress}
                    onChange={(e) => {
                    ...
                    placeholder="Enter your delivery address (e.g., 123 Main St, Sydney NSW)"
                ...
                {bookingData.deliveryAddressDetails && (
                  <div className="mt-3 p-3 bg-mint rounded-lg">
                    <p className="text-sm text-dark font-semibold">✓ Address confirmed: {bookingData.deliveryAddress}</p>
                  </div>
                )}
              </div>
            </Card>
