-- ============================================
-- COMPLETE FRESH START - Washlee Database
-- ============================================
-- This script provides a complete fresh start:
-- 1. Drops all existing tables
-- 2. Creates all tables with correct schema
-- 3. Sets up indexes, RLS policies, and triggers
--
-- Run this entire script in Supabase SQL Editor
-- Then import your CSV data files
-- ============================================
...
-- 2. Import your CSV data files from CSV_IMPORTS/ folder
-- 3. Test admin collections - they should now work!